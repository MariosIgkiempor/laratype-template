...
final class AddTeamMember implements AddsTeamMembers
{
    ...
    public function handle(User $user, Team $team, string $email, ?string $role = null): void
    {
        $this->add($user, $team, $email, $role);
    }
     ...
     */
    private function rules(): array // @phpstan-ignore-line
    {
        return array_filter([
